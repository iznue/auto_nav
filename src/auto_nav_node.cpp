...
void move_goal(int floor, double x, double y, double o_w, double z = 0.0, double o_x = 0.0, double o_y = 0.0, double o_z = 0.0)
{
...
*/
    ...
    if (floor == 1){ 
    	move_goal(floor, 13.345133781433105, 2.9770946502685547, 0.6344656174287334, 0.0, 0.0, 0.0, 0.7729510853222059);
    } else if (floor == 5){
    	move_goal(floor, 5.0, 2.0, 1.0);
    } else{
